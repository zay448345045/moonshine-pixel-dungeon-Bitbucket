...
public class PathFinder {
	...
	public static void setMapSize( int width, int height ) {
        ...
        NEIGHBOURS25 = new int[]{-width-width-2,-width-width-1,-width-width,-width-width+1,-width-width+2,
        ...
        NEIGHBOURS24 = new int[]{-width-width-2,-width-width-1,-width-width,-width-width+1,-width-width+2,
                ...
                width-2,       width-1,       width,       width+1,       width+2,
                width+width-2, width+width-1, width+width, width+width+1, width+width+2};
        NEIGHBOURS16 = new int[]{-width-width-2,-width-width-1,-width-width,-width-width+1,-width-width+2,
                                 -width-2,                                                 -width+2,
                                 -2,                                                       2,
                                 width-2,                                                  width+2,
                                 width+width-2, width+width-1, width+width, width+width+1, width+width+2};
