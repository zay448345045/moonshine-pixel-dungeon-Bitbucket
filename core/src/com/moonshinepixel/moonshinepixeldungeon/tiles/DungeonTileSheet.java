...
public class DungeonTileSheet {
	...
	public static HashSet<Integer> waterStitcheable = new HashSet<>(Arrays.asList(
			...
			Terrain.TRAP, Terrain.TRAP_FRIENDLY, Terrain.TRAP_FRIENDLY_SPEC, Terrain.TRAP_FRIENDLY_WATR, Terrain.INACTIVE_TRAP, Terrain.EMPTY_DECO,
	...
	static {
		...
		chasmStitcheable.put( Terrain.TRAP_FRIENDLY,CHASM_FLOOR );
		chasmStitcheable.put( Terrain.TRAP_FRIENDLY_SPEC,CHASM_FLOOR );
		chasmStitcheable.put( Terrain.TRAP_FRIENDLY_WATR,CHASM_FLOOR );
	...
	static {
		...
		directVisuals.put(Terrain.TRAP_FRIENDLY,    directVisuals.get(Terrain.EMPTY));
		directVisuals.put(Terrain.TRAP_FRIENDLY_SPEC,directVisuals.get(Terrain.EMPTY_SP));
		directVisuals.put(Terrain.TRAP_FRIENDLY_WATR,directVisuals.get(Terrain.WATER));
