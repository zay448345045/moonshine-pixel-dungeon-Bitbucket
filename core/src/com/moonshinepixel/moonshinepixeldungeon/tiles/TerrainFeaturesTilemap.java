...
public class TerrainFeaturesTilemap extends DungeonTilemap {
	...
	private SparseArray<TrapObject> trapsObjects;

	public TerrainFeaturesTilemap(SparseArray<Plant> plants, SparseArray<Trap> traps, SparseArray<TrapObject> trapObjects) {
		super(Assets.TERRAIN_FEATURES);

		this.plants = plants;
		this.traps = traps;
		this.trapsObjects = trapObjects;
