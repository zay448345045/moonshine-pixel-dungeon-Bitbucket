...
public class Messages {
	...
	private static String[] prop_files = new String[]{
			"com.moonshinepixel.moonshinepixeldungeon.messages.actors.actors",
			"com.moonshinepixel.moonshinepixeldungeon.messages.items.items",
			"com.moonshinepixel.moonshinepixeldungeon.messages.levels.levels",
			"com.moonshinepixel.moonshinepixeldungeon.messages.plants.plants",
			"com.moonshinepixel.moonshinepixeldungeon.messages.scenes.scenes",
			"com.moonshinepixel.moonshinepixeldungeon.messages.ui.ui",
			"com.moonshinepixel.moonshinepixeldungeon.messages.windows.windows",
			"com.moonshinepixel.moonshinepixeldungeon.messages.misc.misc"
	};
	...
	public static String get(Class c, String k, Object...args){
		String key;
		if (c != null){
			key = c.getName().replace("com.moonshinepixel.moonshinepixeldungeon.", "");
			key += "." + k;
		} else
			key = k;
