...
import com.moonshinepixel.moonshinepixeldungeon.actors.buffs.Berserk;
...
import com.moonshinepixel.moonshinepixeldungeon.windows.WndChooseWay;
	...
	public void execute( Hero hero, String action ) {
		...
		if (action.equals( AC_READ )) {
			...
			case HUNTRESS:
				...
				break;
			case GUNSLINGER:
				way1 = HeroSubClass.GANGSTER;
				way2 = HeroSubClass.BOMBERMAN;
				break;
			}
