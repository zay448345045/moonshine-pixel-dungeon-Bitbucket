...
public class TrapPlacer extends Item {
    ...
    public static HashSet<Class<? extends Trap>> tounPickupable = new HashSet(Arrays.asList(AlarmTrap.class, CursingTrap.class, DisarmingTrap.class, DistortionTrap.class,GrimTrap.class,GuardianTrap.class,PitfallTrap.class,SummoningTrap.class,WarpingTrap.class,DeadlySpearTrap.class,DarkVenomTrap.class));
