...
import com.moonshinepixel.moonshinepixeldungeon.actors.blobs.StormGas;
import com.watabou.noosa.audio.Sample;

public class PotionOfStorm extends Potion {
	...
	public void shatter( int cell ) {
		...
		GameScene.add( Blob.seed( cell, 1000, StormGas.class ) );
	}
