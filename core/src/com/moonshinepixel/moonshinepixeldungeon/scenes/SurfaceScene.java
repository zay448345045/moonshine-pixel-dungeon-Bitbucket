...
public class SurfaceScene extends PixelScene {
	...
	public void create() {
		...
		Avatar a = new Avatar( Dungeon.hero.heroClass, Dungeon.hero.gender );
		...
		CharSprite[] charSprites = new CharSprite[]{
                new SwarmSprite(){
                    @Override
		...
		final CharSprite pet = Random.element(charSprites);
//		final CharSprite pet = charSprites[charSprites.length-3];
