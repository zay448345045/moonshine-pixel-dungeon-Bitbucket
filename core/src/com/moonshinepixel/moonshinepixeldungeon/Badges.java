...
import com.moonshinepixel.moonshinepixeldungeon.actors.mobs.Shielded;
...
import com.moonshinepixel.moonshinepixeldungeon.actors.mobs.Acidic;
import com.moonshinepixel.moonshinepixeldungeon.actors.mobs.Albino;
import com.moonshinepixel.moonshinepixeldungeon.actors.mobs.Bandit;
import com.moonshinepixel.moonshinepixeldungeon.actors.mobs.Mob;
import com.moonshinepixel.moonshinepixeldungeon.actors.mobs.Senior;
...
public class Badges {
	...
	public enum Badge {
		...
		BOSS_SLAIN_3_SNIPER,
		BOSS_SLAIN_3_WARDEN,
		BOSS_SLAIN_3_GANGSTER,
		BOSS_SLAIN_3_BOMBERMAN,
		...
		if (badge != null) {
			...
			if (badge == Badge.BOSS_SLAIN_1) {
				switch (Dungeon.hero.heroClass) {
					...
					break;
					case GUNSLINGER:
					badge = Badge.BOSS_SLAIN_1_GUNSLINGER;
					break;
				}
				local.add( badge );
				...
				if (global.contains( Badge.BOSS_SLAIN_1_WARRIOR ) &&
					...
					global.contains( Badge.BOSS_SLAIN_1_GUNSLINGER ) &&
			...
			if (badge == Badge.BOSS_SLAIN_3) {
				...
				case WARDEN:
					...
					break;
					case BOMBERMAN:
					badge = Badge.BOSS_SLAIN_3_BOMBERMAN;
					break;
					case GANGSTER:
					badge = Badge.BOSS_SLAIN_3_GANGSTER;
					break;
				default:
					return;
				}
				...
				if (global.contains( Badge.BOSS_SLAIN_3_GLADIATOR ) &&
					...
					global.contains( Badge.BOSS_SLAIN_3_BOMBERMAN ) &&
					global.contains( Badge.BOSS_SLAIN_3_GANGSTER )) {
	...
	public static void validateMastery() {
		...
		case HUNTRESS:
			...
			break;
			case GUNSLINGER:
			badge = Badge.MASTERY_GUNSLINGER;
			break;
		}
