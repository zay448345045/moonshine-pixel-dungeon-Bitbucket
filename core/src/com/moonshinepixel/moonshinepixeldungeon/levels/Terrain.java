...
public class Terrain {
	...
	public static final int TRAP_FRIENDLY	= 30;
	public static final int TRAP_FRIENDLY_SPEC= 31;
	public static final int TRAP_FRIENDLY_WATR= 32;
	...
	static {
		...
		flags[TRAP]         = AVOID;
		flags[TRAP_FRIENDLY]= flags[EMPTY];
		flags[TRAP_FRIENDLY_SPEC]= flags[EMPTY];
		flags[TRAP_FRIENDLY_WATR]= flags[EMPTY];
