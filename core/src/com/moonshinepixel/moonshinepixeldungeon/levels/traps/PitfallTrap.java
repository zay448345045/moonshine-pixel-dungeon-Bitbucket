...
public class PitfallTrap extends Trap {
	...
	protected void disarm() {
		...
		int stateChanges = 0;
		boolean curPassable = Level.getPassable(pos + PathFinder.CIRCLE8[PathFinder.CIRCLE8.length-1]);
		for (int i : PathFinder.CIRCLE8){
			if (curPassable != Level.getPassable(pos + i)){
				stateChanges++;
				curPassable = Level.getPassable(pos + i);
			}
		}
