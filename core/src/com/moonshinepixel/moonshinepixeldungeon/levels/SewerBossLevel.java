...
import com.moonshinepixel.moonshinepixeldungeon.levels.rooms.special.RatKingRoom;
import com.moonshinepixel.moonshinepixeldungeon.levels.rooms.standard.EmptyRoom;
import com.moonshinepixel.moonshinepixeldungeon.levels.rooms.standard.SewerBossEntranceRoom;
...
public class SewerBossLevel extends SewerLevel {
	...
	protected void createItems() {
		...
		if (item != null) {
			...
			} while (pos == entrance || map[pos] == Terrain.SIGN || getSolid(pos));
